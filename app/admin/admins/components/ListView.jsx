...
return (
<div className="flex-1 flex flex-col gap-3 md:pr-5 md:px-0 rounded-xl w-full md:w-[400px]">
...
<thead>
    <tr>
        ...
        <th className="font-semibold border-y bg-white px-3 py-2 border-r rounded-r-lg text-left">Actions</th>
    </tr>
</thead>
<tbody>
